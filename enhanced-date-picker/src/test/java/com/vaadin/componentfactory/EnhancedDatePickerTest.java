...
public class EnhancedDatePickerTest {
    ...
    public void datePicker_basicCases() {
        EnhancedDatePicker picker = new EnhancedDatePicker();
    ...
    public void setInitialValue() {
        EnhancedDatePicker picker = new EnhancedDatePicker(LocalDate.of(2018, 4, 25));
    ...
    public void assertClearButtonPropertyValueEquals(EnhancedDatePicker picker, Boolean value) {
