...
public abstract class GeneratedEnhancedDatePicker<R extends GeneratedEnhancedDatePicker<R, T>, T>
     ...
     *               cancel: 'Cancel',
     *
     *               // A function to setPattern given {@code Object} as
     *               // date string. Object is in the setPattern {@code { day: ..., month: ..., year: ... }}
     *               // Note: The argument month is 0-based. This means that January = 0 and December = 11.
     *               formatDate: d =&gt; {
     *                 // returns a string representation of the given
     *                 // object in 'MM/DD/YYYY' -setPattern
     *               },
     *
     *               // A function to parse the given text to an {@code Object} in the setPattern {@code { day: ..., month: ..., year: ... }}.
     *               // Must properly parse (at least) text formatted by {@code formatDate}.
     *               // Setting the property to null will disable keyboard input feature.
     *               // Note: The argument month is 0-based. This means that January = 0 and December = 11.
     *               parseDate: text =&gt; {
     *                 // Parses a string in 'MM/DD/YY', 'MM/DD' or 'DD' -setPattern to
     *                 // an {@code Object} in the setPattern {@code { day: ..., month: ..., year: ... }}.
     *               }
     *
     *               // A function to setPattern given {@code monthName} and
    ...
    @DomEvent("change")
    public static class ChangeEvent<R extends GeneratedEnhancedDatePicker<R, ?>>
    ...
    public static class InvalidChangeEvent<R extends GeneratedEnhancedDatePicker<R, ?>>
            extends ComponentEvent<R> {
    ...
    public static class OpenedChangeEvent<R extends GeneratedEnhancedDatePicker<R, ?>>
            extends ComponentEvent<R> {
    ...
    /**
     * Constructs a new GeneratedEnhancedDatePicker component with the given
     * arguments.
     *
     * @param initialValue
     ...
     *            the property type
     */
    public <P> GeneratedEnhancedDatePicker(T initialValue, T defaultValue,
     ...
     */
    public GeneratedEnhancedDatePicker(T initialValue, T defaultValue,
     ...
     * Default constructor.
     */
    public GeneratedEnhancedDatePicker() {
