...
@JavaScript("frontend://date-fns-limited.js")
...
public class EnhancedDatePicker extends GeneratedEnhancedDatePicker<EnhancedDatePicker, LocalDate>
     ...
     * @see #setLabel(String)
     */
    public EnhancedDatePicker(String label) {
        this();
        setLabel(label);
    }
     ...
     * @see #setLabel(String)
     */
    public EnhancedDatePicker(String label, LocalDate initialDate) {
        this(initialDate);
        setLabel(label);
    }
     ...
     */
    public EnhancedDatePicker(
            ValueChangeListener<ComponentValueChangeEvent<EnhancedDatePicker, LocalDate>> listener) {
        this();
     ...
     * {@link EnhancedDatePicker#setI18n(DatePickerI18n)}
     *
    ...
    public Registration addOpenedChangeListener(
            ComponentEventListener<OpenedChangeEvent<EnhancedDatePicker>> listener) {
    ...
    /**
     * The internationalization properties for {@link EnhancedDatePicker}.
     */
